...
nhanh_orders_144 AS (
  SELECT
    ...
    -- cho mọi đơn TRỪ đơn hủy/hoàn (58,63,64,71,72,74).
    CASE WHEN ANY_VALUE(order_status) NOT IN ('58','63','64','71','72','74')
...
orders_facts AS (
  SELECT
    ...
    order_status,
    CASE
      WHEN order_status = '60'                                          THEN 'thanh_cong'
      WHEN order_status IN ('58','63','64','71','72','74')              THEN 'that_bai'
      ELSE 'dang_xu_ly'
    END AS status_group,
    revenue,
